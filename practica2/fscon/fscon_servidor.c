...
LEER_result *
leer_1_svc(int fd, int nbytes,  struct svc_req *rqstp)
{
...
int *
escribir_1_svc(int fd, int nbytes, BUF buf,  struct svc_req *rqstp)
{
	static int  result;
...
int *
abrir_1_svc(char *nom,  struct svc_req *rqstp)
{
	static int  result;
...
int *
cerrar_1_svc(int fd,  struct svc_req *rqstp)
{
	static int  result;
